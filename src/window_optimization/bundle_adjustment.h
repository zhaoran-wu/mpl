...
class BundleAdjustment {
   public:
    ...
    template <int Dim>
    void setParameterLowerBound(BAParameterBlock<Dim>* parameterBlock, int index, double lowerBound);

    template <int Dim>
    void setParameterUpperBound(BAParameterBlock<Dim>* parameterBlock, int index, double upperBound);

    // ResidualBlock management
    template <int Dim0>
    void addResidualBlock(BAResidualBlock* residualBlock, BAParameterBlock<Dim0>* x0);

    template <int Dim0, int Dim1>
    void addResidualBlock(BAResidualBlock* residualBlock, BAParameterBlock<Dim0>* x0, BAParameterBlock<Dim1>* x1);
    ...
    void addResidualBlock(BAResidualBlock* residualBlock, BAParameterBlock<Dim0>* x0, BAParameterBlock<Dim1>* x1,
                          BAParameterBlock<Dim2>* x2, BAParameterBlock<Dim3>* x3);

    template <int Dim0, int Dim1, int Dim2, int Dim3, int Dim4>
    void addResidualBlock(BAResidualBlock* residualBlock, BAParameterBlock<Dim0>* x0, BAParameterBlock<Dim1>* x1,
                          BAParameterBlock<Dim2>* x2, BAParameterBlock<Dim3>* x3, BAParameterBlock<Dim4>* x4);
    ...
    template <int Dim0, int Dim1, int Dim2, int Dim3, int Dim4, int Dim5, int Dim6, int Dim7>
    void addResidualBlock(BAResidualBlock* residualBlock, BAParameterBlock<Dim0>* x0, BAParameterBlock<Dim1>* x1,
                          BAParameterBlock<Dim2>* x2, BAParameterBlock<Dim3>* x3, BAParameterBlock<Dim4>* x4,
                          BAParameterBlock<Dim5>* x5, BAParameterBlock<Dim6>* x6, BAParameterBlock<Dim7>* x7);

    template <int Dim0, int Dim1, int Dim2, int Dim3, int Dim4, int Dim5, int Dim6, int Dim7, int Dim8>
    void addResidualBlock(BAResidualBlock* residualBlock, BAParameterBlock<Dim0>* x0, BAParameterBlock<Dim1>* x1,
                          BAParameterBlock<Dim2>* x2, BAParameterBlock<Dim3>* x3, BAParameterBlock<Dim4>* x4,
                          BAParameterBlock<Dim5>* x5, BAParameterBlock<Dim6>* x6, BAParameterBlock<Dim7>* x7,
                          BAParameterBlock<Dim8>* x8);

    template <int Dim0, int Dim1, int Dim2, int Dim3, int Dim4, int Dim5, int Dim6, int Dim7, int Dim8, int Dim9>
    void addResidualBlock(BAResidualBlock* residualBlock, BAParameterBlock<Dim0>* x0, BAParameterBlock<Dim1>* x1,
                          BAParameterBlock<Dim2>* x2, BAParameterBlock<Dim3>* x3, BAParameterBlock<Dim4>* x4,
                          BAParameterBlock<Dim5>* x5, BAParameterBlock<Dim6>* x6, BAParameterBlock<Dim7>* x7,
                          BAParameterBlock<Dim8>* x8, BAParameterBlock<Dim9>* x9);
...
template <int Dim>
inline void BundleAdjustment::removeParameterBlock(BAParameterBlock<Dim>* parameterBlock) {
    this->problem_->RemoveParameterBlock(parameterBlock->getParameters());
}

template <int Dim>
inline void BundleAdjustment::setParameterBlockConstant(BAParameterBlock<Dim>* parameterBlock) {
    parameterBlock->setFixed(true);
    this->problem_->SetParameterBlockConstant(parameterBlock->getParameters());
}

template <int Dim>
inline void BundleAdjustment::setParameterBlockVariable(BAParameterBlock<Dim>* parameterBlock) {
    parameterBlock->setFixed(false);
    this->problem_->SetParameterBlockVariable(parameterBlock->getParameters());
}

template <int Dim>
inline void BundleAdjustment::setParameterLowerBound(BAParameterBlock<Dim>* parameterBlock, int index,
                                                     double lowerBound) {
    this->problem_->SetParameterLowerBound(parameterBlock->getParameters(), index, lowerBound);
}

template <int Dim>
inline void BundleAdjustment::setParameterUpperBound(BAParameterBlock<Dim>* parameterBlock, int index,
                                                     double upperBound) {
    this->problem_->SetParameterUpperBound(parameterBlock->getParameters(), index, upperBound);
}

template <int Dim0>
inline void BundleAdjustment::addResidualBlock(BAResidualBlock* residualBlock, BAParameterBlock<Dim0>* x0) {
    // insert into problem
    ceres::ResidualBlockId residualId = this->problem_->AddResidualBlock(
        residualBlock->getCostFunction(), residualBlock->getLossFunction(), x0->getParameters());
...
inline void BundleAdjustment::addResidualBlock(BAResidualBlock* residualBlock, BAParameterBlock<Dim0>* x0,
    ...
    // insert into problem
    ceres::ResidualBlockId residualId = this->problem_->AddResidualBlock(
        residualBlock->getCostFunction(), residualBlock->getLossFunction(), x0->getParameters(), x1->getParameters());
...
inline void BundleAdjustment::addResidualBlock(BAResidualBlock* residualBlock, BAParameterBlock<Dim0>* x0,
    ...
    // insert into problem
    ceres::ResidualBlockId residualId =
        this->problem_->AddResidualBlock(residualBlock->getCostFunction(), residualBlock->getLossFunction(),
...
inline void BundleAdjustment::addResidualBlock(BAResidualBlock* residualBlock, BAParameterBlock<Dim0>* x0,
    ...
    ceres::ResidualBlockId residualId = this->problem_->AddResidualBlock(
        residualBlock->getCostFunction(), residualBlock->getLossFunction(), x0->getParameters(), x1->getParameters(),
        x2->getParameters(), x3->getParameters());
...
inline void BundleAdjustment::addResidualBlock(BAResidualBlock* residualBlock, BAParameterBlock<Dim0>* x0,
    ...
    ceres::ResidualBlockId residualId = this->problem_->AddResidualBlock(
        residualBlock->getCostFunction(), residualBlock->getLossFunction(), x0->getParameters(), x1->getParameters(),
        x2->getParameters(), x3->getParameters(), x4->getParameters());
...
inline void BundleAdjustment::addResidualBlock(BAResidualBlock* residualBlock, BAParameterBlock<Dim0>* x0,
    ...
    ceres::ResidualBlockId residualId = this->problem_->AddResidualBlock(
        residualBlock->getCostFunction(), residualBlock->getLossFunction(), x0->getParameters(), x1->getParameters(),
        x2->getParameters(), x3->getParameters(), x4->getParameters(), x5->getParameters());
...
inline void BundleAdjustment::addResidualBlock(BAResidualBlock* residualBlock, BAParameterBlock<Dim0>* x0,
    ...
    ceres::ResidualBlockId residualId = this->problem_->AddResidualBlock(
        residualBlock->getCostFunction(), residualBlock->getLossFunction(), x0->getParameters(), x1->getParameters(),
        x2->getParameters(), x3->getParameters(), x4->getParameters(), x5->getParameters(), x6->getParameters());
...
inline void BundleAdjustment::addResidualBlock(BAResidualBlock* residualBlock, BAParameterBlock<Dim0>* x0,
    ...
    ceres::ResidualBlockId residualId = this->problem_->AddResidualBlock(
        residualBlock->getCostFunction(), residualBlock->getLossFunction(), x0->getParameters(), x1->getParameters(),
        x2->getParameters(), x3->getParameters(), x4->getParameters(), x5->getParameters(), x6->getParameters(),
        x7->getParameters(), x8->getParameters());
...
inline void BundleAdjustment::addResidualBlock(BAResidualBlock* residualBlock, BAParameterBlock<Dim0>* x0,
    ...
    ceres::ResidualBlockId residualId = this->problem_->AddResidualBlock(
        residualBlock->getCostFunction(), residualBlock->getLossFunction(), x0->getParameters(), x1->getParameters(),
        x2->getParameters(), x3->getParameters(), x4->getParameters(), x5->getParameters(), x6->getParameters(),
        x7->getParameters(), x8->getParameters(), x9->getParameters());
