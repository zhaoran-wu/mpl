...
int main() {
    ...
    std::string vs_file_path =
        "/home/zhaoran/thesis_ws/mpl/shader/photometric.vs";
    std::string fs_file_path =
        "/home/zhaoran/thesis_ws/mpl/shader/photometric.fs";
    std::string vs_file_path2 =
        "/home/zhaoran/thesis_ws/mpl/shader/depth_vis.vs";
    std::string fs_file_path2 =
        "/home/zhaoran/thesis_ws/mpl/shader/depth_vis.fs";
